...
const ProductFeatures = props => {
  return (
    <section className="product-features">
      ...
      <p>
        It takes 25kg of our novel bioherbicide to cover 1 feddan, which will be
        priced at 1000 EGP wholesale.
      </p>
      <div className="core-features">
        <div className="core-feature-1">
          ...
          <h2>95,948,000 EGP</h2>
          <p>Revenue from serviceable market:</p>
        </div>
        <div className="core-feature-3">
          ...
          <h2>160,000,000 EGP</h2>
          <p>Revenue from 50% of total available market:</p>
        </div>
        <div className="core-feature-2">
          ...
          <h2>320,000,000 EGP</h2>
          <p>Revenue from 100% of total available market:</p>
        </div>
      </div>
    </section>
  )
